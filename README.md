...
| 面板右下角“出击” | 返回地图选择敌城，确认敌城后部队才真正离城 |
| 取消 / Esc | 关闭城池面板；选目标时取消回到原城池，不扣兵 |
| 点击或拖动小地图 | 快速定位 |
| 空格 | 回到初始据点 |
| F | 查看全图 |
| G | 显示网格 |
...
点击任意城池直接展开单层详情。标题统一为“阿尔马国”等名称，不显示敌我、等级副标题。我方城池将英雄选择放在靠上的位置，同页显示 HP、战斗、内政、报酬、士兵、王牌及经济情况，底部左侧取消、右侧出击；其他城池显示经济和守军，底部只有取消。确认英雄后在地图上选择红色标记的敌城；点击地面或我方城池不会误派兵，取消选目标回到原城池，保留英雄选择与驻军。
