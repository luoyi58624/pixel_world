...
当前经济、兵力、专属月俸、无限次招募、年度城防升级限制与灭国战利品规则统一见 [战役配置](docs/campaign_config.md)。城防第一年可升至三级、第二年四级、第三年起五级；每月不限制升级次数。全国兵力上限按开局将领数×4加当前全国城防等级总和×4计算，开局满编，升级和占城只扩容。所有城池正常产出，专属将领在本国免薪，其他将领按 JSON 月俸收费，解雇返还内政金币。
