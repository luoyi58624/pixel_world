...
r[$.jC()]=s
p.onmessage=r
q.$1(B.i.an(t.G.a(A.R(["kind","hello","protocol",1,"build","3bea34a4","backend",o],t.N,t.X)),null))},
j0:function j0(){},
...
switch(J.b_(s,"kind")){case"init":if(!J.an(J.b_(s,"protocol"),1)||!J.an(J.b_(s,"build"),"3bea34a4"))throw A.j(B.a4);++i.f
i.e=null
p=i.r
