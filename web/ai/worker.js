...
r[$.jZ()]=s
p.onmessage=r
q.$1(B.j.aq(t.G.a(A.T(["kind","hello","protocol",1,"build","9b3ec05f","backend",o],t.N,t.X)),null))},
jn:function jn(){},
...
switch(J.b2(s,"kind")){case"init":if(!J.af(J.b2(s,"protocol"),1)||!J.af(J.b2(s,"build"),"9b3ec05f"))throw A.j(B.a4);++i.f
i.e=null
p=i.r
