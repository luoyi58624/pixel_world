...
import '../domain/nes/nes_battle_ending.dart';
...
class BattlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.save();
    final origin = camera.toScreen(GamePoint.zero);
    canvas.translate(
