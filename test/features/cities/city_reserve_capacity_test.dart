...
CampaignState _campaign({bool duplicatePlacement = false}) => ongoingCampaign(
...
void main() {
  ...
  test('签约与阵亡都不改变开局将领提供的固定容量', () {
    ...
    expect(c.buySoldiers(2, 4), isFalse);
  ...
  test('守将战败按全国容量裁减，仍由所有友城共同使用', () {
    ...
    expect(c.reserveCapacityFor(0), 32);
    expect(c.soldiersAt(0), 32);
    expect(c.soldiersAt(2), 32);
  });
