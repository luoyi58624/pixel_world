...
void main() {
  ...
  test('野战双方的出发城同时失守，战斗继续，胜败双方最终都清除', () {
    ...
    final point = field(c);
    final am = c.dispatchTo(a, point + const Offset(80, 0))!;
    final bm = c.dispatchTo(
      b,
      point - const Offset(80, 0),
      countryId: b.countryId,
    )!;
    am.position = point - const Offset(8, 0);
    bm.position = point + const Offset(8, 0);
    c.advance(0.02);
