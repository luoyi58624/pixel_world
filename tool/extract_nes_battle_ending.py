...
const nesBattleResultWindow = GameRect.fromLTWH(80, 16, 96, 32);

/// 结果字模在战斗画布上的起点。
const nesBattleResultTextOrigin = GamePoint(96, 24);
...
'''.replace('VICTORY', str(cues[0])).replace('DEFEAT', str(cues[1]))
    (output / 'lib/features/battle/domain/nes/nes_battle_ending.dart').write_text(dart, encoding='utf-8')
